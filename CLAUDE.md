...
- `npm run verify:deploy <url>` - Check a live deployment's endpoints and webhook wiring
...
This project is indexed by GitNexus as **my-helper** (1547 symbols, 3347 relationships, 103 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/my-helper/context` | Codebase overview, check index freshness |
| `gitnexus://repo/my-helper/clusters` | All functional areas |
| `gitnexus://repo/my-helper/processes` | All execution flows |
| `gitnexus://repo/my-helper/process/{name}` | Step-by-step execution trace |
